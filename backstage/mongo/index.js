...
const daySentence = require("./modules/sentence")
...
/**
 *  查找每日句子
 * @param {object} dayInfo 学生信息
 */
module.exports.searchDay = function (dayInfo) {
  consule.log(dayInfo.toString())
  consule.log(daySentence.findOne(dayInfo))
  return daySentence.findOne(dayInfo)
}
